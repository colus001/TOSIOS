 ...
 */
export function createTilemap(width: number, height: number, value: number): TileMap {
 ...
 * Resize a tilemap.
 */
export function resizeTileMap(tilemap: TileMap, width: number, height: number): TileMap {
